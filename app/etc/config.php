    ...
    'system' => [
        'default' => [
            'admin' => [
                ...
                'startup' => [
                    'menu_item_id' => 'Magento_Catalog::catalog_products',
                ],
                'url' => [
                    'use_custom' => '0',
                    'use_custom_path' => '0',
                ...
                'security' => [
                    ...
                    'lockout_failures' => '6',
                    'lockout_threshold' => '9300',
                    'password_lifetime' => '9900',
                    'password_is_forced' => '0',
                    'session_lifetime' => '315360',
...
Disallow: /*SID=
                ...
                'theme' => [
                    'theme_id' => 'frontend/Tsum/knowledge-theme',
                ],
            ],
            'dev' => [
                'debug' => [
            ...
            'currency' => [
                'options' => [
                    'allow' => 'EUR,RUB,USD,UAH',
                    'base' => 'USD',
                    'default' => 'USD',
                ],
                'fixerio' => [
                    'timeout' => '100',
                    'api_key' => '0:3:4hiC4gpSU/41QV8e8F8n02NJ9S/cY7RmX0v179EKe3y3GD3YdXJUS2pmz5ax+iEfDIekSPggwdv5pJMR',
                ],
...
{{depend vat_id}}VAT: {{var vat_id}}{{/depend}}|',
            ...
            'msp_securitysuite_twofactorauth' => [
                ...
                'duo' => [
                    'application_key' => 'NLdAFN5TIUKRMGu4Tfy0WaQtuhfiuyy0Ro71JsPJn0YE9hf7okxxcSnvc4zS0fIt',
                ],
            ],
            'connector_dynamic_content' => [
                'external_dynamic_content_urls' => [
                    'passcode' => 'GF4bzLKsEttYbLCC1OCbzqU5lHz4GIXN',
                ],
            ],
            ...
            'yotpo' => [
                'module_info' => [
                    'yotpo_installation_date' => '2019-10-30',
                ],
                'sync_settings' => [
                    'orders_sync_start_date' => '2019-10-30',
                ],
            ],
            'mage2dark' => [
                'settings' => [
                    'enabled' => '0',
                    'theme_selection' => 'auto',
                    'light_theme_time_from' => '420',
                    'light_theme_time_to' => '870',
                ],
            ],
            'cash_flow' => [
                'general' => [
                    'storage_attribute_set' => '10',
                ],
            ],
        ],
        'stores' => [
    ...
    'themes' => [
        ...
        'frontend/Tsum/knowledge-theme' => [
            'parent_id' => 'Magento/blank',
            'theme_path' => 'Tsum/knowledge-theme',
            'theme_title' => 'Tsum Knowledge',
            'is_featured' => '0',
            'area' => 'frontend',
            'type' => '0',
            'code' => 'Tsum/knowledge-theme',
        ],
        'adminhtml/MageSpices/Mage2Dark' => [
            'parent_id' => 'Magento/backend',
            'theme_path' => 'MageSpices/Mage2Dark',
            'theme_title' => 'Mage2Dark - Admin Theme',
            'is_featured' => '0',
            'area' => 'adminhtml',
            'type' => '0',
            'code' => 'MageSpices/Mage2Dark',
        ],
        'adminhtml/Tsum/cf-theme' => [
            'parent_id' => 'Magento/backend',
            'theme_path' => 'Tsum/cf-theme',
            'theme_title' => 'Tsum Admin Cash Flow',
            'is_featured' => '0',
            'area' => 'adminhtml',
            'type' => '0',
            'code' => 'Tsum/cf-theme',
