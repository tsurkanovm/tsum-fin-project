...
/**
 * Dispatcher for the `tsum_cf_transfer_save_after` event.
 */
class TransferSaveAfterObserver implements ObserverInterface
{
    ...
    /**
     * Handle the `tsum_cf_transfer_save_after` event.
     *
