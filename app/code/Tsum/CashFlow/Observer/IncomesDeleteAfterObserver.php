...
/**
 * Dispatcher for the `tsum_cf_incomes_delete_after` event.
 */
class IncomesDeleteAfterObserver implements ObserverInterface
{
    ...
    /**
     * Handle the `tsum_cf_incomes_delete_after` event.
     *
