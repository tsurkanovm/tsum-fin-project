...
/**
 * Dispatcher for the `tsum_cf_incomes_save_after` event.
 */
class IncomesSaveAfterObserver implements ObserverInterface
{
    ...
    /**
     * Handle the `tsum_cf_incomes_save_after` event.
     *
