...
namespace Tsum\CashFlow\Block\Adminhtml\Order\Create\Search;
...
use Tsum\CashFlow\Block\Adminhtml\Grid\Column\Renderer\StorageSelect;
...
//        );
        ...
        $this->addColumn(
            ...
            [
                ...
                'type' => 'select',
                'header' => __('Cash Flow'),
                'renderer' => StorageSelect::class,
                'name' => 'cf_item',
//                'column_css_class' => 'input-text',
//                'header_css_class' => 'input-text',
